const hljs = (function () {
  ...
  function t (n) {
    return (
      ...
      Object.getOwnPropertyNames(n).forEach(function (e) {
        e = n[e]
        typeof e !== 'object' || Object.isFrozen(e) || t(e)
      }),
      n
    )
  }
  ...
  function d (...e) {
    let n
    var t =
      typeof (n = (t = e)[t.length - 1]) === 'object' &&
  ...
  const A = (e, n) => {
    N[e + '/' + n] ||
      (console.log(`Deprecated as of ${e}. ` + n), (N[e + '/' + n] = !0))
  }
  const S = new Error()
  ...
  function q (e) {
    ...
    if (Array.isArray(n.end)) {
      if (n.skip || n.excludeEnd || n.returnEnd) {
        throw (
          (j('skip, excludeEnd, returnEnd not compatible with endScope: {}'), S)
        )
      }
      if (typeof n.endScope !== 'object' || n.endScope === null) {
        throw (j('endScope must be object'), S)
      }
      M(n, n.end, { key: 'endScope' }), (n.end = g(n.end, { joinWith: '' }))
    }
  }
  function Q (r) {
    function s (e, n) {
    ...
    class n {
      ...
      compile () {
        ...
        (this.matcherRe = s(g(e, { joinWith: '|' }), !0)), (this.lastIndex = 0)
      }
      ...
      exec (e) {
        ...
        if (!n) return null
        var e = n.findIndex((e, n) => n > 0 && void 0 !== e)
        const t = this.matchIndexes[e]
    ...
    return (
      ...
      (function n (t, a) {
        ...
        if (!t.isCompiled) {
          ...
          (e = e || /\w+/),
          t.keywords && (t.keywords = _(t.keywords, r.case_insensitive)),
          ...
          a &&
              ...
              t.endsWithParent &&
                a.terminatorEnd &&
                (i.terminatorEnd += (t.end ? '|' : '') + a.terminatorEnd)),
          ...
          (t.contains = [].concat(
            ...t.contains.map(function (e) {
              ...
              return (
                n.variants &&
                    !n.cachedVariants &&
                    (n.cachedVariants = n.variants.map(function (e) {
                      return l(n, { variants: null }, e)
                    })),
                n.cachedVariants ||
                    ((function e (n) {
                      return !!n && (n.endsWithParent || e(n.starts))
                    })(n)
                      ? l(n, { starts: n.starts ? l(n.starts) : null })
                      : Object.isFrozen(n)
                        ? l(n)
                        : n)
              )
  ...
  m = (function (a) {
    ...
    function l (e, n, t, a) {
      ...
      let r = ''
      typeof n === 'object'
        ? ((i = e), (t = n.ignoreIllegals), (r = n.language), (a = void 0))
        : (A('10.7.0', 'highlight(lang, code, ...args) has been deprecated.'),
          A(
            '10.7.0',
    ...
    function B (r, s, o, e) {
      ...
      function c () {
        if (m.keywords) {
          let e = 0
          let n =
            ((m.keywordPatternRe.lastIndex = 0), m.keywordPatternRe.exec(v))
          let t = ''
          for (; n;) {
            t += v.substring(e, n.index)
            const a = p.case_insensitive ? n[0].toLowerCase() : n[0]
            let i = m.keywords[a]
            if (i) {
              const [r, s] = i
              E.addText(t),
              ...
              r.startsWith('_')
                ? (t += n[0])
                : ((i = p.classNameAliases[r] || r), E.addKeyword(n[0], i))
            } else t += n[0];
          ...
          ? function () {
            if (v !== '') {
              ...
              if (typeof m.subLanguage === 'string') {
                ...
                (e = B(m.subLanguage, v, !0, f[m.subLanguage])),
                (f[m.subLanguage] = e._top)
              } else e = T(v, m.subLanguage.length ? m.subLanguage : null)
              m.relevance > 0 && (w += e.relevance),
      ...
      function u (e, n) {
        ...
        e.beginScope &&
            (e.beginScope._wrap
              ? (E.addKeyword(
                  v,
                  p.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap
                ),
                (v = ''))
              : e.beginScope._multi && (i(e.beginScope, n), (v = ''))),
      ...
      function g (e) {
        ...
        for (const r of [a.__beforeBegin, a['on:begin']]) {
          if (r && (r(e, i), i.isMatchIgnored)) {
            return (
              (n = t),
              m.matcher.regexIndex === 0 ? ((v += n[0]), 1) : ((N = !0), 0)
            )
          }
        }
        return (
      ...
      function b (e) {
        const n = e[0]
        let t = s.substr(e.index)
        const a = (function e (n, t, a) {
          (r = n.endRe), (s = a)
          let i = (r = r && r.exec(s)) && r.index === 0
          let r, s
          if (
            i &&
            (n['on:end'] &&
              ((s = new D(n)), n['on:end'](t, s), s.isMatchIgnored && (i = !1)),
            i)
          ) {
      ...
      function n (e, n) {
        ...
        if (n.type === 'illegal' && t === '') return 1
        if (_ > 1e5 && _ > 3 * n.index) {
          throw new Error(
      ...
      if (!p) {
        throw (
          (j(M.replace('{}', r)), new Error('Unknown language: "' + r + '"'))
        )
      }
      const t = Q(p)
      let a = ''
      let m = e || t
      const f = {}
      const E = new R.__emitter(R)
      {
        const k = []
        for (let e = m; e !== p; e = e.parent) e.scope && k.unshift(e.scope)
      ...
      try {
        for (m.matcher.considerAll(); ;) {
          ...
          const x = m.matcher.exec(s)
          if (!x) break
          const A = n(s.substring(y, x.index), x)
          y = x.index + A
        }
        return (
          n(s.substr(y)),
    ...
    function n (e) {
      ...
      let i = (function (e) {
        ...
        let t
        const a = R.languageDetectRe.exec(n)
        return a
          ? ((t = I(a[1])) ||
              (x(M.replace('{}', a[1])),
      ...
      o(i) ||
        ...
        u('after:highlightElement', {
          el: e,
          result: (n = i ? l(t, { language: i, ignoreIllegals: !0 }) : T(t)),
          text: t
        }),
        (e.innerHTML = n.value),
        (t = e),
    ...
    let t = !1
    function e () {
      if (document.readyState === 'loading') t = !0
      else {
    ...
    function c (e, { languageName: n }) {
      (e = typeof e === 'string' ? [e] : e).forEach((e) => {
        r[e.toLowerCase()] = n
      })
    }
    function d (e) {
    ...
    Object.assign(a, {
      ...
      highlightBlock: function (e) {
        return (
          A('10.7.0', 'highlightBlock will be removed entirely in v12.0'),
      ...
      addPlugin: function (e) {
        ...
        (n = e)['before:highlightBlock'] &&
            ...
            (n['before:highlightElement'] = (e) => {
              n['before:highlightBlock'](Object.assign({ block: e.el }, e))
            }),
        n['after:highlightBlock'] &&
              !n['after:highlightElement'] &&
              (n['after:highlightElement'] = (e) => {
                n['after:highlightBlock'](Object.assign({ block: e.el }, e))
              }),
        i.push(e)
      }
    }),
    ...
    for (const g in y) typeof y[g] === 'object' && z(y[g])
  ...
  const ie = ['true', 'false', 'null', 'undefined', 'NaN', 'Infinity']
  const re = [
    'Intl',
    'DataView',
    'Number',
  ...
  function de (e) {
    ...
    const s = (e, n) => {
      ...
      a === '<'
        ...
        : a === '>' &&
          (([a, e] = [e, { after: t }.after]),
          (t = '</' + a[0].slice(1)),
          a.input.indexOf(t, e) === -1 && n.ignoreMatch())
    }
    const o = {
      $pattern: R,
      keyword: ae,
    ...
    var l = '[0-9](_?[0-9])*'
    var c = `\\.(${l})`
    var d = '0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*'
    var l = {
      className: 'number',
      variants: [
        ...
        A,
        {
          ...
          contains: [
            ...
            { match: /\s+/, relevance: 0 },
            {
              ...
              subLanguage: 'xml',
              contains: [{ begin: i, end: r, skip: !0, contains: ['self'] }]
            }
          ]
        },
        w,
  ...
  function ge (e) {
    ...
    return {
      ...
      contains: [
        ...
        { className: 'attribute', begin: '\\b(' + te.join('|') + ')\\b' },
        {
          begin:
  ...
  const be = Object.freeze({
    ...
    grmr_json5: ue,
    grmr_xml: function (e) {
      const n = O(/[A-Z_]/, O('(?:', /[A-Z0-9_.-]*:/, ')?'), /[A-Z0-9_.-]*/)
      const t = {
        className: 'symbol',
      ...
      const i = e.inherit(a, { begin: /\(/, end: /\)/ })
      const r = e.inherit(e.APOS_STRING_MODE, { className: 'string' })
      const s = e.inherit(e.QUOTE_STRING_MODE, { className: 'string' })
      const o = {
        endsWithParent: !0,
        illegal: /</,
        relevance: 0,
    ...
    grmr_markdown: function (e) {
      ...
      let r = [n, t];
      (a.contains = a.contains.concat(r)), (i.contains = i.contains.concat(r))
      const s = {
        className: 'section',
        variants: [
          { begin: '^#{1,6}', end: '$', contains: (r = r.concat(a, i)) },
          {
            begin: '(?=^.+?\\n[=-]{2,}$)',
            contains: [
              { begin: '^[=-]*$' },
      ...
      const o = { className: 'quote', begin: '^>\\s+', contains: r, end: '$' }
      return {
        name: 'Markdown',
    ...
    grmr_typescript: function (e) {
      ...
      const t = { className: 'meta', begin: '@[A-Za-z$_][0-9A-Za-z$_]*' }
      const a = (e, n, t) => {
        const a = e.contains.findIndex((e) => e.label === n)
        if (a === -1) throw new Error('can not find mode to replace')
      ...
      const r =
        ...
        i.contains.find((e) => e.label === 'func.def'))
      return (
        (r.relevance = 0),
    ...
    grmr_yaml: function (e) {
      ...
      return (
        ...
        l.push(i),
        (r.contains = l),
        { name: 'YAML', case_insensitive: !0, aliases: ['yml'], contains: t }
      )
    }
  })
  const he = m
  for (const B of Object.keys(be)) {
    const pe = B.replace('grmr_', '')
    he.registerLanguage(pe, be[B])
  }
  return he
})()
